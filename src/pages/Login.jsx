...
const Login = () => {
  ...
  if (currentUser) {
    return <Navigate to={currentUser.role === 'lecturer' ? '/lecturer-dashboard' : '/student-dashboard'} replace />;
  }
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="bg-blue-50 rounded-lg p-4">
              ...
              <div className="space-y-1 text-xs text-blue-700">
                <p><strong>Lecturer:</strong> lecturer@quiziti.com / password123</p>
                <p><strong>Student:</strong> student1@quiziti.com / password123</p>
              </div>
            </div>
          </form>
        </div>
